# Lab 4: Trajectory Planning Simulation
### Team Member: Zhuoran Duan, Zixuan Fan, Likai Wei  

Lab5 is a state estimator implemented on a two wheeled robot to determine the current states of the robot. The state estimator of the lab is based on Extended Kalman Filter.    
